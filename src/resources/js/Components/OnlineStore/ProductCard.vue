<template>
    <div
        class="product-card group rounded-lg bg-white p-4 transition-all duration-300 hover:shadow-lg"
    >
        <!-- Изображение -->
        <div class="mb-4 aspect-square overflow-hidden rounded-md bg-gray-100">
            <img
